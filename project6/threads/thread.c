...
// unsigned file_hash(const struct hash_elem *e, void *aux)
// {
//   struct thread_file *i = hash_entry(e, struct thread_file, file_elem);
//   return hash_int(i->fd);
// }

// bool file_compare(const struct hash_elem *a, const struct hash_elem *b, void *aux)
// {
//   struct thread_file *i_a = hash_entry(a, struct thread_file, file_elem);
//   struct thread_file *i_b = hash_entry(b, struct thread_file, file_elem);
...
init_thread(struct thread *t, const char *name, int priority)
{
  ...
  // Initialize the children list and exit status
